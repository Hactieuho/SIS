...
public class ApachePost {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ApachePost http = new ApachePost();
        http.sendPost();
        http.sendGet();
        ApachePost.parse(src);
    }
    ...
    private void sendPost() throws Exception {
        ...
        urlParameters.add(new BasicNameValuePair("ctl00$cLogIn1$tb_cLogIn_User", "20142072"));
        urlParameters.add(new BasicNameValuePair("ctl00$cLogIn1$tb_cLogIn_Pass", "quenmatroi"));
